CREATE TABLE [dbo].[Deliveries] (
    ...
    PRIMARY KEY CLUSTERED ([SenderNbr] ASC, [MessageTypeNbr] ASC, [SenderUTC] ASC, [SubscriberNbr] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [FK__dbo_Deliveries_dbo_Subscriptions] FOREIGN KEY ([SenderNbr], [MessageTypeNbr], [SubscriberNbr]) REFERENCES [dbo].[Subscriptions] ([SenderNbr], [MessageTypeNbr], [SubscriberNbr]),
    CONSTRAINT [FK_dbo_Deliveries_dbo_Mailbox] FOREIGN KEY ([SenderNbr], [MessageTypeNbr], [SenderUTC]) REFERENCES [dbo].[Mailbox] ([SenderNbr], [MessageTypeNbr], [SenderUTC]),
